...
from autogenerated_email import send_email_bot_completion, get_email_for_username, sender_email, sender_password, subject, body
...
def process_document(directory_path):
    ...
    try:
        send_email_bot_completion(sender_email, sender_password, extracted_mail, subject, body)
